public class Member
{
    ...
    private static int _totalBooksBorrowed;
    public static int TotalBooksBorrowed
    {
        get { return _totalBooksBorrowed; }
        set
        {
            ...
            if (value < 0)
                _totalBooksBorrowed = 0;
            else
                _totalBooksBorrowed = value;
        }
    }
    ...
    private static int _standardMaxBookBorrowed = 3;
    private static int _premiumMaxBookBorrowed = 5;
    private static int _vipMaxBookBorrowed = 10;
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        if (MembershipLevel == "Standard")
            return _standardMaxBookBorrowed;

        if (MembershipLevel == "Premium")
            return _premiumMaxBookBorrowed;

        if (MembershipLevel == "VIP")
            return _vipMaxBookBorrowed;
    ...
    public void BorrowBook()
    {
        ...
        if (_booksBorrowed < GetMaxBorrowLimit())
        {
            _booksBorrowed++;
            TotalBooksBorrowed++;
        }
