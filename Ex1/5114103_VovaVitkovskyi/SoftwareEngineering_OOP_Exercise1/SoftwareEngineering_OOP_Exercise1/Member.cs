public class Member
{
    ...
    private static int standardMax = 3;
    private static int premiumMax = 5;
    private static int vipMax = 10;
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        if (MembershipLevel.ToLower() == "standard") 
        {
            return standardMax;
        } 
        else if (MembershipLevel.ToLower() == "premium")
        {
            return premiumMax;
        }
        else if (MembershipLevel.ToLower() == "vip")
        {
            return vipMax;
        }
