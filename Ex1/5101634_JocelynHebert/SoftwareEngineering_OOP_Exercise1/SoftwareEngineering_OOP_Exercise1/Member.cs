...
public class Member
{
    ...
    private static int totalMembersAdded { get; set; }
    ...
    public static int TotalBooksBorrowed
    {
        ...
        set
        {
            ...
            totalBooksBorrowed = (totalBooksBorrowed < 0) ? 0 : totalBooksBorrowed;
    ...
    private static int standardMember = 3;
    private static int premiumMember = 5;
    private static int vipMember = 10;
    ...
    public string GetBooksBorrowed()
    {
        ...
        return $"Here is the current number of borrowed books for the user: {totalBooksBorrowed} ";
    }
